...
var PHR_ADDONS = require('./gulp-addons');
...
gulp.task('serve', ['vendorScripts', 'javascript', 'styles'], function () {
  ...
  gulp.watch('assets/icons/**', ['phr:icons']);
...
// -------------------- (Font generation related) ----------------------------//
// ---------------------------------------------------------------------------//
gulp.task('phr:icons', function (done) {
  var args = [
    'node_modules/collecticons-processor/bin/collecticons.js',
    'compile',
    'assets/icons/',
    ...
    '--font-types', 'woff',
    '--style-format', 'sass',
    '--style-dest', 'assets/styles/phr-design-system',
    '--style-name', 'phr-icons',
    '--class-name', 'phr-icon',
    '--author-name', 'Development Seed',
    '--author-url', 'https://developmentseed.org/',
    '--no-preview'
